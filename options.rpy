...
define config.name = _("Blake in white")
...
define build.name = "BlakeInWhite"
...
##
## Windows: %APPDATA\BlakeInWhite\<config.save_directory>
##
##Macintosh: $HOME/Library/BlakeInWhite/<config.save_directory>
##
##Linux: $HOME/BlakeInWhite/<config.save_directory>.
##
...
define config.save_directory = "BlakeInWhiteSave"
