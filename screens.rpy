...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Карманы") action Preference("auto-forward", "toggle")
            textbutton _("Дневник") action ShowMenu('dictionary')
...
screen dictionary():
    ...
    textbutton ("Назад") xalign 0.05 yalign 0.95 action Return()


## Уведомление дневника
screen info_dict:
    vbox:
        xpos 15
        ypos 15
        text "В дневнике появлились {b}новые записи{/b}!"